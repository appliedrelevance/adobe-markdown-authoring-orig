...
export function checkMarkdownlintCustomProperty() {
	...
	const customRuleset = "{adobe.adobe-markdown-authoring}/dist-rules/rules-bundle.js";
	const docsMarkdownRuleset = "{adobe.adobe-markdown-authoring}/dist-rules/rules-bundle.js";
