...
import { addErrorContext, addErrorDetailIf, addWarningContext, alltags, blocktags, blocktags_with_options, containsAfmTag, ErrorContext, FilterParams, filterTokens, forEachLine, inlinetags, isInCodeBlock } from "../shared";
...
module.exports = {
    ...
    "tags": ["adobe-markdown", "admonitions", "blockquotes", "code-blocks", "html-blocks", "inline-tags", "block-tags"],
    "function": function AM009(params: FilterParams, onError: (context: ErrorContext) => void) {
        ...
        filterTokens(params, 'html_block', function forToken(token: MarkdownItToken) {
        ...
        filterTokens(params, "blockquote_open", function forToken(token: MarkdownItToken) {
            var line = token.line;
