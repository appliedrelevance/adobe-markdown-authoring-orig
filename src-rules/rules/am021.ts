...
import { addErrorContext, blocktags, ErrorContext, FilterParams, filterTokens, inlinetags } from "../shared";
...
module.exports = {
    ...
    "function": function AM021(params: FilterParams, onError: (context: ErrorContext) => void) {
